...
This is the function: $f_0(t; a_0) = a_0$ where $f_0(t) = 100$ & $t \geq 0$. This function is not solvable for when the output is 80 because there is never a point in this model where the brightness drops below 100% of its original intensity.
...
Written numerically: $f_3(x) = 100.65313 - 0.65313 * e^{-0.02026 * x}$
